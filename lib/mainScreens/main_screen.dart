...
import 'package:vitcab_app/assistants/geofire_assistant.dart';
...
import 'package:vitcab_app/main.dart';
import 'package:vitcab_app/mainScreens/rate_driver_screen.dart';
import 'package:vitcab_app/mainScreens/search_places_screen.dart';
import 'package:vitcab_app/mainScreens/select_nearest_active_drivers_screen.dart';
import 'package:vitcab_app/models/active_nearby_available_drivers.dart';
import 'package:vitcab_app/models/direction_details_info.dart';
import 'package:vitcab_app/widgets/my_drawer.dart';
import 'package:vitcab_app/widgets/progress_dialog.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  saveRideRequestInformation()
  {
    ...
    referenceRideRequest = FirebaseDatabase.instance.ref().child("All Ride Requests").push();  //ghas4445
  ...
  searchNearestOnlineDrivers() async
  {
    ...
    if(onlineNearByAvailableDriversList.length == 0)
      {
        //we have to cancel the riderequest information
        ...
        Fluttertoast.showToast(msg: " No Online Nearest Driver Available. search again for ride after some time, restarting app");
          ...
          if(snap.snapshot.value != null)
          {
                ...
                .onValue.listen((eventSnapshot)
            {
              ...
              if(eventSnapshot.snapshot.value == "accepted")
              {
                ...
                //design and displaying ui for displaying assigned driver information
            ...
            child: GestureDetector(
              onTap: () {
                if (openNavigationDrawer) {
                  ...
                  //restart-refresh app programitically
                  SystemNavigator.pop();
                }
              },
              child: CircleAvatar(
  ...
  initializeGeoFireListener() {
    ...
    Geofire.queryAtLocation(
      ...
      if (map != null) {
        ...
        switch (callBack) {
        //whenever driver became active online
          case Geofire.onKeyEntered:
            ...
            break;
             ...
             //whenever driver became nonactive /offline
